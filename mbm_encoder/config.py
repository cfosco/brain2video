...
class Config_MBM_fMRI(Config_MAE_fMRI):
    ...
    # MAE for fMRI
        ...
        self.batch_size = 100
        self.clip_grad = 0.8
        self.load_checkpoint = None #"./results/fmri_pretrain/05-09-2023-15-11-47/checkpoints/checkpoint.pth"
...
class Config_MBM_finetune(Config_MBM_finetune):
    def __init__(self):
        ...
        self.bmd_path = "/gpfs/u/home/SIFA/SIFApnbw/scratch/datasets/bmd/"
